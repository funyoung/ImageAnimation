 ...
 *
 */
public final class SyncProfileClient extends HttpRequestExecutor {
...
//    }
//
    public  String getProfile(String uid, String sessionTicket) throws IOException, ApiException {
        HttpRequestBase request = new HttpRequestBuilder(HttpRequestBuilder.GET, MODULE, Servlet.COMMAND_GET_PROFILE)
	...
	public String syncProfile(String uid, String sessionTicket, String localInfo) throws ApiException, IOException{
	    HttpRequestBuilder reqBuilder = new HttpRequestBuilder(HttpRequestBuilder.POST, MODULE,
    ...
    public  String getProfile(String uid, String sessionTicket) throws IOException, ApiException{
        ...
        if (mGetCount%7 == 1){
            ...
            throw new ApiException(211, "profile test account exception");
