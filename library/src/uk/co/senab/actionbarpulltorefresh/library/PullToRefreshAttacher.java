...
public class PullToRefreshAttacher implements View.OnTouchListener {
    ...
    public static abstract class HeaderTransformer {
         ...
         * {@link uk.co.senab.actionbarpulltorefresh.library.PullToRefreshAttacher.Options#headerLayout}.
         *
         ...
         * from {@link uk.co.senab.actionbarpulltorefresh.library.PullToRefreshAttacher.OnRefreshListener} but is more suitable for header view updates.
         */
         ...
         * called when {@link uk.co.senab.actionbarpulltorefresh.library.PullToRefreshAttacher.Options#refreshOnUp} is set to true.
         */
        public abstract void onReleaseToRefresh();

        /**
         * Called when the current refresh has taken longer than the time specified in
         * {@link uk.co.senab.actionbarpulltorefresh.library.PullToRefreshAttacher.Options#refreshMinimizeDelay}.
         */
    ...
    public static class Options {
         ...
         * {@link uk.co.senab.actionbarpulltorefresh.library.PullToRefreshAttacher.DefaultHeaderTransformer} will be used.
         */
